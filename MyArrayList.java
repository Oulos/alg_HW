...
public class MyArrayList<T extends Comparable<T>> {
    ...
    private boolean isLoadLimit (int size) {
        return size > (list.length * 75) / 100;
    }

    private T[] copyToNewList (T[] list) {
        T[] newList = (T[]) new Comparable[(int) (list.length * 1.5)];
